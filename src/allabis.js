/**
 * Hey guys, we're going to copy and paste every single ABI into
 * one single 18,000 line file
 * Why?
 * Because we have the collective intelligence of an autistic chimpanzee
 * and because fuck anyone who tries to read our code in the future
 * --Curve Frontend Devs
 **/

export var infura_url =
  "https://mainnet.infura.io/v3/c334bb4b45a444979057f0fb8a0c9d1b";

export const distributor_address = "0x55A48Bad47785D23D543c3D43d97A8F84811c33B";
...
// //change
// export const geyser_ysnow_address = "0x6195A24eF78656e5F9E4a87B88f70A20011e91e7";
// export const geyser_ycrvsnow_address = "0xd80f00951Bf035A6F704FD9d5df8D83EEA49b530";
// //change

// export const geyser_uniethsnow_address = "0x0F97F6f5ec551b42DFf8fdcacAC161F0AEcca10e";

export const geyser_abi = [
  {
    constant: false,
    inputs: [
      {
...
export const geyser_ycrvsnow_snow = "0x836f75DbDE052C61AA63E69ACb6f177C541B2efe";
export const ycrvsnow_snow_unilp = "0xb43A0beca632c286CD1D5748a749561c49b02b08";

export const geyser_ysnow_snow = "0x13bD7AbEbAcffF6ecd6D9f737177EB88d8B60b81";
export const ysnow_snow_unilp = "0x4A80683E4Dad35581f3C528851b647C77191bF78";

export const geyser_snow_eth = "0x6639c50Ac9e6A04Cc6c9FE1a76451699d1B0B76c";
export const snow_eth_unilp = "0xE4f8F3CB9b33247789e4984A457bb69A1a621Df3";

export const snow_address = "0xfe9a29ab92522d14fc65880d817214261d8479ae";
// export const snow_address_uni = "0xe4f8f3cb9b33247789e4984a457bb69a1a621df3";
// export const ySnow_address = "0x173f8ee61C0FE712caE2a2fc8d5c0ccDDa57E6dA";
// export const ycrvSnow_address = "0x078b728243b975d1a284666C30B30530a8c087fe";
...
var iearn = {
  ...
  //NOTE: The Deposit zap is currently broken and needs to be redeployed
  deposit_address: "0x1F50352628430D7573E19119cDbd6bdCca4d05C4",
  deposit_abi: [
    {
      outputs: [],
      inputs: [
...
var busd = {
  ...
  is_plain: [false, false],
  swap_address: "0xBf7CCD6C446acfcc5dF023043f2167B62E81899b",
  token_address: "0x078b728243b975d1a284666C30B30530a8c087fe",
  ...
  //There is NO deposit zap or ABI yet
  //TODO: deploy one and add her
  deposit_address: "0xaED724D4DBb0e0C9Dd811752A0e4bcAE4317e869",
  deposit_abi: [
    {
      outputs: [],
      inputs: [
...
var ren = {
  ...
  adapterABI: [
    ...
    },
    {
      ...
      name: "exchange",
      outputs: [
        { internalType: "contract ICurveExchange", name: "", type: "address" },
      ],
      stateMutability: "view",
      type: "function",
    },
    ...
    {
      inputs: [
        { internalType: "uint256", name: "_minExchangeRate", type: "uint256" },
        {
          internalType: "uint256",
    ...
    },
    {
      inputs: [
        { internalType: "bytes", name: "_btcDestination", type: "bytes" },
        { internalType: "uint256", name: "_token_amounts", type: "uint256" },
    ...
    },
    {
      inputs: [
        { internalType: "bytes", name: "_btcDestination", type: "bytes" },
        { internalType: "uint256", name: "_amount", type: "uint256" },
        { internalType: "uint256", name: "_minRenbtcAmount", type: "uint256" },
      ],
      name: "swapThenBurn",
      outputs: [],
      stateMutability: "nonpayable",
  ...
  adapterABI: [
    ...
    },
    {
      ...
      inputs: [
        ...
        { indexed: false, internalType: "int128", name: "j", type: "int128" },
      ],
      name: "SwapReceived",
      type: "event",
    },
    ...
    },
    {
      inputs: [
        ...
        { internalType: "uint256", name: "_amount", type: "uint256" },
        { internalType: "uint256[3]", name: "_amounts", type: "uint256[3]" },
        { internalType: "uint256", name: "_min_mint_amount", type: "uint256" },
        {
          internalType: "uint256",
          name: "_new_min_mint_amount",
    ...
    },
    {
      inputs: [
        { internalType: "bytes", name: "_btcDestination", type: "bytes" },
        { internalType: "address", name: "_coinDestination", type: "address" },
...
export let synthetixExchanger_ABI = [
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: "uint256", name: "_waitingPeriodSecs", type: "uint256" },
    ],
...
export let adapterABI = [
  ...
  },
  {
    ...
    inputs: [
      { internalType: "uint256", name: "_minExchangeRate", type: "uint256" },
      { internalType: "uint256", name: "_newMinExchangeRate", type: "uint256" },
      { internalType: "uint256", name: "_slippage", type: "uint256" },
      {
        internalType: "address payable",
        name: "_wbtcDestination",
  ...
  },
  {
    ...
    name: "registry",
    outputs: [
      { internalType: "contract IGatewayRegistry", name: "", type: "address" },
    ],
    payable: false,
    stateMutability: "view",
    type: "function",
