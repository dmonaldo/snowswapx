      ...
      <div :class="{ selected: activeLink == 0 }">
        ...
        >
          ...
          <img
            ...
            :src="
              publicPath +
              'klein-vyper_optimized.svg?rev=98185d4fe81a0ff9206e8b34c66e2be5'
            "
            alt="🌀 Curve"
          />
          <span class="text">Curve-related Vyper research</span>
        </a>
      </div>
      <div :class="{ selected: activeLink == 1 }">
        ...
        >
          ...
          <img
            ...
            :src="
              publicPath +
              'ethereum-brands_optimized.svg?rev=8160e2e87988f42e44fd33495dead52c'
            "
          />
          <span class="text">0x28b88cfD875C883cDb61938C97B8d1baabf31c88</span>
        </a>
      </div>
      <div :class="{ selected: activeLink == 2 }">
        ...
        >
          ...
          <img
            ...
            :src="
              publicPath +
              'btc-brands_optimized.svg?rev=7cbd9f5561d25b6aa72c5ee927a9f10a'
            "
          />
          <span class="text">1C5UfsRKCzEbDbQxKLN7Jx8HFA1ff6dfp4</span>
        </a>
      </div>
    </fieldset>
  </div>
...
export default {
  metaInfo: {
    title: "snowswap.org :: Donate",
    meta: [
      { property: "og:title", content: "snowswap.org/donate" },
      { property: "og:url", content: "https://snowswap.org/donate" },
      ...
      { name: "twitter:title", content: "snowswap.org/donate" },
      ...
      { name: "twitter:url", content: "https://snowswap.org/donate" },
