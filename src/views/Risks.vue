<template>
	<div :class="{'window white': $route.path == '/risks'}">
        ...
        <p>
            Providing liquidity on SnowSwap doesn't come without risks. Before making a deposit, it is best to research and understand the risks involved.
        </p>

        <a href='https://www.snowswap.org/stableswap-paper.pdf'>Whitepaper</a>
        ...
        <h3>
            <a href='https://guides.snowswap.org/how-to-choose-the-right-curve-pool-for-you/' rel='noopener noreferrer'>Learn more about each pool's risks</a>
        </h3>
