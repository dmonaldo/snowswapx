...
export default {
  ...
  computed: {
    ...
    totalProfit() {
      let profits = [
        +this.showProfit,
        +this.showEarnedSNXUSD,
        +this.showEarnedRENUSD,
        +this.showRewardsSNXUSD,
        +this.showRewardsRENUSD,
        +this.showEarnedCRVUSD,
        +this.showRewardsCRVUSD,
      ];
