      ...
      <div class="poolsdialog">
        <h3>
          ...
          <span class="tooltip" v-show="+sumBalances > 0">
            ...
            <span class="tooltiptext">
              Your total balances: ${{
                +sumBalances.toFixed(2) | formatNumber(0)
              }}
            </span>
          </span>
        </h3>
        ...
        >
          <router-link to="/compound">
            <div class="col col--1">
              <span class="pooltext">yVault USD</span>
            </div>
            ...
            <div class="col col--2">
              ...
              <span class="volume">
                ...
                <span
                  :class="{
                    'loading line': volumes.compound && volumes.compound[0] < 0,
                  }"
                >
                  <span v-show="volumes.compound && volumes.compound[0] >= 0">
                    ${{
                      (volumes.compound && volumes.compound[0] | 0)
                        | formatNumber(0)
                    }}
                  </span>
                  <span v-show="!volumes.compound && volumes.compound[0]">
                    $0
                  </span>
                </span>
              </span>
            ...
            <div class="col col--3">
              <span>
                ...
                <span :class="{ 'loading line': !daily_apy[0] }">
                  {{ daily_apy[0] }}
                </span>
                %
              </span>
              ...
              <div :class="{ 'incentive-apr': true }">
                +{{ CRVAPYs.compound && CRVAPYs.compound[0].toFixed(2) }}%
                <!--                <br />-->
                to {{ CRVAPYs.compound && CRVAPYs.compound[1].toFixed(2) }}%
                <span v-show="CRVAPYs.compound && CRVAPYs.compound[3]">
                  <br />
                  my:
                  {{
                    CRVAPYs.compound &&
                    CRVAPYs.compound[3] > 0 &&
                    CRVAPYs.compound[3].toFixed(2)
                  }}%&nbsp;
                </span>
                <!--                <span class="tooltip">-->
                <span>
                  <!--                  <img class="icon small" :src="publicPath + 'logo.png'" />-->
                  SNOW
                  <!--                  <span class="tooltiptext long">-->
                  <!--                    CRV LP reward annualized(max APY can be reached with max-->
                  <!--                    boost of-->
                  <!--                    {{ CRVAPYs.compound && CRVAPYs.compound[2].toFixed(2) }})-->
                  <!--                  </span>-->
                </span>
              </div>
            </div>
            ...
            <!--            <span class="balance">-->
            <!--              <span class="showmobile" v-show="balances.compound > 0">-->
            <!--                Balance: ${{-->
            <!--                  (balances.compound && balances.compound.toFixed(2))-->
            <!--                    | formatNumber(0)-->
            <!--                }}-->
            <!--              </span>-->
        ...
        >
          <router-link to="/pax">
            <div class="col col--1">
              <span class="pooltext">yVault Curve</span>
            </div>

            <div class="col col--2">
              <span class="pools">yUSD, ycrvBUSD</span>

              <span class="volume">
                Vol:
                <span
                  :class="{ 'loading line': volumes.pax && volumes.pax[0] < 0 }"
                >
                  <span v-show="volumes.pax && volumes.pax[0] >= 0">
                    ${{ (volumes.pax && volumes.pax[0] | 0) | formatNumber(0) }}
                  </span>
            ...
            <div class="col col--3">
              <span>
                ...
                <span :class="{ 'loading line': !daily_apy[5] }">
                  {{ daily_apy[5] }}
                </span>
                %
              </span>
              ...
              <div :class="{ 'incentive-apr': true }">
                +{{ CRVAPYs.pax && CRVAPYs.pax[0].toFixed(2) }}%
                <!--                <br />-->
                to {{ CRVAPYs.pax && CRVAPYs.pax[1].toFixed(2) }}%
                <span v-show="CRVAPYs.pax && CRVAPYs.pax[3]">
                  <br />
                  my:
                  {{
                    CRVAPYs.pax &&
                    CRVAPYs.pax[3] > 0 &&
                    CRVAPYs.pax[3].toFixed(2)
                  }}%&nbsp;
                </span>
                <span>SNOW</span>
              </div>
            ...
            <!--            <span class="balance">-->
            <!--              <span class="showmobile" v-show="balances.pax > 0">-->
            <!--                Balance: ${{-->
            <!--                  (balances.pax && balances.pax.toFixed(2)) | formatNumber(0)-->
            <!--                }}-->
            <!--              </span>-->
        ...
        <!--                </span>-->
        <!--              </span>-->
        <!--              <span :class="{ 'loading line': !daily_apy[2] }">-->
        <!--                {{ daily_apy[2] }}-->
        <!--              </span>-->
        <!--              %-->
        <!--              &lt;!&ndash; <div :class="{'loading line': yfiRewards === null, 'incentive-apr': true}">(+{{yfiRewards | toFixed2}}%-->
        ...
        <!--                    		</div> &ndash;&gt;-->
        <!--              <div :class="{ 'incentive-apr': true }">-->
        <!--                (+{{ CRVAPYs.y && CRVAPYs.y[0].toFixed(2) }}%-->
        <!--                <br />-->
        <!--                to {{ CRVAPYs.y && CRVAPYs.y[1].toFixed(2) }}%-->
        <!--                <span v-show="CRVAPYs.y && CRVAPYs.y[3]">-->
        <!--                  <br />-->
        <!--                  my:-->
        <!--                  {{-->
        <!--                    CRVAPYs.y && CRVAPYs.y[3] > 0 && CRVAPYs.y[3].toFixed(2)-->
        <!--                  }}%&nbsp;-->
        <!--                </span>-->
        <!--                <span class="tooltip">-->
        <!--                  <img class="icon small" :src="publicPath + 'logo.png'" />-->
        ...
        <!--                  <span class="tooltiptext long">-->
        <!--                    CRV LP reward annualized(max APY can be reached with max-->
        <!--                    boost of {{ CRVAPYs.y && CRVAPYs.y[2].toFixed(2) }})-->
        <!--                  </span>-->
        <!--                </span>-->
        <!--                )-->
        <!--              </div>-->
        ...
        <!--            <span class="volume">-->
        <!--              Vol:-->
        <!--              <span :class="{ 'loading line': volumes.y && volumes.y[0] < 0 }">-->
        <!--                <span v-show="volumes.y && volumes.y[0] >= 0">-->
        <!--                  ${{ (volumes.y && volumes.y[0] | 0) | formatNumber(0) }}-->
        <!--                </span>-->
        <!--                <span v-show="!volumes.y && volumes.y[0]">$0</span>-->
        <!--              </span>-->
        <!--            </span>-->
        <!--            <span class="balance">-->
        <!--              <span class="showmobile" v-show="balances.y > 0">-->
        <!--                Balance: ${{-->
        <!--                  (balances.y && balances.y.toFixed(2)) | formatNumber(0)-->
        <!--                }}-->
        <!--              </span>-->
        ...
        <!--                </span>-->
        <!--              </span>-->
        <!--              <span :class="{ 'loading line': !daily_apy[3] }">-->
        <!--                {{ daily_apy[3] }}-->
        <!--              </span>-->
        <!--              %-->
        <!--              <div :class="{ 'incentive-apr': true }">-->
        <!--                (+{{ CRVAPYs.busd && CRVAPYs.busd[0].toFixed(2) }}%-->
        <!--                <br />-->
        <!--                to {{ CRVAPYs.busd && CRVAPYs.busd[1].toFixed(2) }}%-->
        <!--                <span v-show="CRVAPYs.busd && CRVAPYs.busd[3]">-->
        <!--                  <br />-->
        <!--                  my:-->
        <!--                  {{-->
        <!--                    CRVAPYs.busd &&-->
        <!--                    CRVAPYs.busd[3] > 0 &&-->
        <!--                    CRVAPYs.busd[3].toFixed(2)-->
        <!--                  }}%&nbsp;-->
        <!--                </span>-->
        <!--                <span class="tooltip">-->
        <!--                  <img class="icon small" :src="publicPath + 'logo.png'" />-->
        ...
        <!--                  <span class="tooltiptext long">-->
        <!--                    CRV LP reward annualized(max APY can be reached with max-->
        <!--                    boost of {{ CRVAPYs.busd && CRVAPYs.busd[2].toFixed(2) }})-->
        <!--                  </span>-->
        <!--                </span>-->
        <!--                )-->
        <!--              </div>-->
        ...
        <!--              Vol:-->
        <!--              <span-->
        <!--                :class="{ 'loading line': volumes.busd && volumes.busd[0] < 0 }"-->
        <!--              >-->
        <!--                <span v-show="volumes.busd && volumes.busd[0] >= 0">-->
        <!--                  ${{ (volumes.busd && volumes.busd[0] | 0) | formatNumber(0) }}-->
        <!--                </span>-->
        <!--                <span v-show="!volumes.busd && volumes.busd[0]">$0</span>-->
        <!--              </span>-->
        <!--            </span>-->
        <!--            <span class="balance">-->
        <!--              <span class="showmobile" v-show="balances.busd > 0">-->
        <!--                Balance: ${{-->
        <!--                  (balances.busd && balances.busd.toFixed(2)) | formatNumber(0)-->
        <!--                }}-->
        <!--              </span>-->
        ...
        <!--                <span class="tooltiptext">-->
        <!--                  Balance: ${{-->
        <!--                    (balances.busd && balances.busd.toFixed(2))-->
        <!--                      | formatNumber(0)-->
        <!--                  }}-->
        <!--                </span>-->
        <!--              </span>-->
        ...
        <!--          </router-link>-->
        <!--        </div>-->
        <!--        &lt;!&ndash; <div :class="{selected: activePoolLink == 4}">-->
        ...
        <!--                    <div>-->
        <!--                      Monthly APY:-->
        <!--                      {{ +monthly_apy[4] == 0 ? "N/A" : monthly_apy[4] }}%-->
        <!--                    </div>-->
        <!--                    <div>Total APY: {{ apy[4] }}%</div>-->
        <!--                  </span>-->
        <!--                </span>-->
        <!--                <span :class="{ 'loading line': !daily_apy[4] }">-->
        <!--                  {{ daily_apy[4] }}%-->
        <!--                </span>-->
        <!--                <div-->
        <!--                  :class="{-->
        <!--                    'loading line': snxRewards === null,-->
        <!--                    'incentive-apr': true,-->
        <!--                  }"-->
        <!--                >-->
        <!--                  (+{{ snxRewards | toFixed2 }}%-->
        <!--                  <span class="tooltip">-->
        <!--                    SNX-->
        <!--                    <span class="tooltiptext">SNX LP reward annualized</span>-->
        <!--                  </span>-->
        <!--                  )-->
        <!--                </div>-->
        <!--                <div :class="{ 'incentive-apr': true }">-->
        <!--                  (+{{ CRVAPYs.susdv2 && CRVAPYs.susdv2[0].toFixed(2) }}%-->
        <!--                  <br />-->
        <!--                  to {{ CRVAPYs.susdv2 && CRVAPYs.susdv2[1].toFixed(2) }}%-->
        <!--                  <span v-show="CRVAPYs.susdv2 && CRVAPYs.susdv2[3]">-->
        <!--                    <br />-->
        <!--                    my:-->
        <!--                    {{-->
        <!--                      CRVAPYs.susdv2 &&-->
        <!--                      CRVAPYs.susdv2[3] > 0 &&-->
        <!--                      CRVAPYs.susdv2[3].toFixed(2)-->
        <!--                    }}%&nbsp;-->
        <!--                  </span>-->
        <!--                  <span class="tooltip">-->
        <!--                    <img class="icon small" :src="publicPath + 'logo.png'" />-->
        ...
        <!--                      CRV LP reward annualized(max APY can be reached with max-->
        <!--                      boost of-->
        <!--                      {{ CRVAPYs.susdv2 && CRVAPYs.susdv2[2].toFixed(2) }})-->
        <!--                    </span>-->
        <!--                  </span>-->
        <!--                  )-->
        <!--                </div>-->
        ...
        <!--              Vol:-->
        <!--              <span-->
        <!--                :class="{ 'loading line': volumes.susd && volumes.susd[0] < 0 }"-->
        <!--              >-->
        <!--                <span v-show="volumes.susd && volumes.susd[0] >= 0">-->
        <!--                  ${{ (volumes.susd && volumes.susd[0] | 0) | formatNumber(0) }}-->
        <!--                </span>-->
        <!--                <span v-show="!volumes.susd && volumes.susd[0]">$0</span>-->
        <!--              </span>-->
        <!--            </span>-->
        <!--            <span class="balance">-->
        <!--              <span class="showmobile" v-show="balances.susdv2 > 0">-->
        <!--                Balance: ${{-->
        <!--                  (balances.susdv2 && balances.susdv2.toFixed(2))-->
        <!--                    | formatNumber(0)-->
        <!--                }}-->
        <!--              </span>-->
        ...
        <!--          </router-link>-->
        <!--        </div>-->
        <!--        &lt;!&ndash; <div :class="{selected: activePoolLink == 5}">-->
        <!--	                <router-link to = '/tbtc'>-->
        ...
        <!--                </span>-->
        <!--              </span>-->
        <!--              <span :class="{ 'loading line': !daily_apy[7] }">-->
        <!--                {{ daily_apy[7] }}-->
        <!--              </span>-->
        <!--              %-->
        <!--              <div :class="{ 'incentive-apr': true }">-->
        <!--                (+{{ CRVAPYs.ren && CRVAPYs.ren[0].toFixed(2) }}%-->
        <!--                <br />-->
        <!--                to {{ CRVAPYs.ren && CRVAPYs.ren[1].toFixed(2) }}%-->
        <!--                <span v-show="CRVAPYs.ren && CRVAPYs.ren[3]">-->
        <!--                  <br />-->
        <!--                  my:-->
        <!--                  {{-->
        <!--                    CRVAPYs.ren &&-->
        <!--                    CRVAPYs.ren[3] > 0 &&-->
        <!--                    CRVAPYs.ren[3].toFixed(2)-->
        <!--                  }}%&nbsp;-->
        <!--                </span>-->
        <!--                <span class="tooltip">-->
        <!--                  <img class="icon small" :src="publicPath + 'logo.png'" />-->
        ...
        <!--                  <span class="tooltiptext long">-->
        <!--                    CRV LP reward annualized(max APY can be reached with max-->
        <!--                    boost of {{ CRVAPYs.ren && CRVAPYs.ren[2].toFixed(2) }})-->
        <!--                  </span>-->
        <!--                </span>-->
        <!--                )-->
        <!--              </div>-->
        ...
        <!--              Vol:-->
        <!--              <span-->
        <!--                :class="{ 'loading line': volumes.ren && volumes.ren[0] < 0 }"-->
        <!--              >-->
        <!--                <span v-show="volumes.ren && volumes.ren[0] >= 0">-->
        <!--                  ${{ (volumes.ren && volumes.ren[0] | 0) | formatNumber(0) }}-->
        <!--                </span>-->
        <!--              </span>-->
        <!--            </span>-->
        <!--            <span class="balance">-->
        <!--              <span class="showmobile" v-show="balances.ren > 0">-->
        <!--                Balance: ${{-->
        <!--                  (balances.ren && balances.ren.toFixed(2)) | formatNumber(0)-->
        <!--                }}-->
        <!--              </span>-->
        ...
        <!--                    <div>-->
        <!--                      Monthly APY:-->
        <!--                      {{ +monthly_apy[8] == 0 ? "N/A" : monthly_apy[8] }}%-->
        <!--                    </div>-->
        <!--                    <div>Total APY: {{ apy[8] }}%</div>-->
        <!--                  </span>-->
        <!--                </span>-->
        <!--                <span :class="{ 'loading line': !daily_apy[8] }">-->
        <!--                  {{ daily_apy[8] }}%-->
        <!--                </span>-->
        <!--                &lt;!&ndash; <div :class="{'loading line': sbtcRewards === null, 'incentive-apr': true}">(+{{sbtcRewards | toFixed2}}%-->
        ...
        <!--	                    		</div> &ndash;&gt;-->
        <!--                <div :class="{ 'incentive-apr': true }">-->
        <!--                  (+{{ CRVAPYs.sbtc && CRVAPYs.sbtc[0].toFixed(2) }}%-->
        <!--                  <br />-->
        <!--                  to {{ CRVAPYs.sbtc && CRVAPYs.sbtc[1].toFixed(2) }}%-->
        <!--                  <span v-show="CRVAPYs.sbtc && CRVAPYs.sbtc[3]">-->
        <!--                    <br />-->
        <!--                    my:-->
        <!--                    {{-->
        <!--                      CRVAPYs.sbtc &&-->
        <!--                      CRVAPYs.sbtc[3] > 0 &&-->
        <!--                      CRVAPYs.sbtc[3].toFixed(2)-->
        <!--                    }}%&nbsp;-->
        <!--                  </span>-->
        <!--                  <span class="tooltip">-->
        <!--                    <img class="icon small" :src="publicPath + 'logo.png'" />-->
        ...
        <!--                    <span class="tooltiptext long">-->
        <!--                      CRV LP reward annualized(max APY can be reached with max-->
        <!--                      boost of {{ CRVAPYs.sbtc && CRVAPYs.sbtc[2].toFixed(2) }})-->
        <!--                    </span>-->
        <!--                  </span>-->
        <!--                  )-->
        <!--                </div>-->
        ...
        <!--              Vol:-->
        <!--              <span-->
        <!--                :class="{ 'loading line': volumes.sbtc && volumes.sbtc[0] < 0 }"-->
        <!--              >-->
        <!--                <span v-show="volumes.sbtc && volumes.sbtc[0] >= 0">-->
        <!--                  ${{ (volumes.sbtc && volumes.sbtc[0] | 0) | formatNumber(0) }}-->
        <!--                </span>-->
        <!--              </span>-->
        <!--            </span>-->
        <!--            <span class="balance">-->
        <!--              <span class="showmobile" v-show="balances.sbtc > 0">-->
        <!--                Balance: ${{-->
        <!--                  (balances.sbtc && balances.sbtc.toFixed(2)) | formatNumber(0)-->
        <!--                }}-->
        <!--              </span>-->
        ...
        <!--                <span class="tooltiptext">-->
        <!--                  Balance: ${{-->
        <!--                    (balances.sbtc && balances.sbtc.toFixed(2))-->
        <!--                      | formatNumber(0)-->
        <!--                  }}-->
        <!--                </span>-->
        <!--              </span>-->
...
export default {
  ...
  methods: {
    async getCurveRewards() {
      this.getCRVAPY();
      let curveRewards = new contract.web3.eth.Contract(
        allabis.susdv2.sCurveRewards_abi,
        allabis.susdv2.sCurveRewards_address
      );
      let sbtcRewards = new contract.web3.eth.Contract(
        allabis.sbtc.sCurveRewards_abi,
        allabis.sbtc.sCurveRewards_address
      );
      let yfiRewards = new contract.web3.eth.Contract(
        allabis.iearn.sCurveRewards_abi,
        allabis.iearn.sCurveRewards_address
      );

      let sCurve = new contract.web3.eth.Contract(
        allabis.susdv2.swap_abi,
        allabis.susdv2.swap_address
      );
      let sbtcCurve = new contract.web3.eth.Contract(
        allabis.sbtc.swap_abi,
        allabis.sbtc.swap_address
      );
      let yCurve = new contract.web3.eth.Contract(
        allabis.iearn.swap_abi,
        allabis.iearn.swap_address
      );

      let balancerPool = new contract.web3.eth.Contract(
        balancer_ABI,
        balancer_address
      );
      ...
      let calls = [
        ...
        [
          ...
          curveRewards.methods.periodFinish().encodeABI(),
        ],
      ...
      this.balRewards =
        ((((decoded[6] / 1e18) * snxPrice + (decoded[7] / 1e18) * renPrice) *
          0.64) /
          balancerTVL) *
        balPrice *
        100;
      ...
      this.snxRewards =
        ((((365 * ((decoded[2] * decoded[3]) / 1e18)) / 7) * snxPrice) /
          ((+decoded[0] * +decoded[1]) / 1e36)) *
        100;
      let now = Date.now() / 1000;
      if (+decoded[12] + 30 * 60 < now) this.snxRewards = 0;

      this.sbtcRewards =
        ((((10000 * snxPrice + 25000 * renPrice) / 7) * 365) /
          ((btcPrice * decoded[4] * decoded[5]) / 1e36)) *
        100;
      if (+decoded[13] + 30 * 60 < now) this.sbtcRewards = 0;

      this.yfiRewards =
        ((((365 * ((decoded[10] * decoded[11]) / 1e18)) / 7) * yfiPrice) /
          ((+decoded[8] * +decoded[9]) / 1e36)) *
        100;
      if (+decoded[14] + 30 * 60 < now) this.yfiRewards = 0;
    ...
    async fetchPrices() {
      let requests = await Promise.allSettled([
        fetch(
          "https://api.coingecko.com/api/v3/simple/price?ids=havven,republic-protocol,bitcoin,balancer,yearn-finance&vs_currencies=usd"
        ),
        fetch("https://pushservice.snowswap.org/static/tvl.txt"),
      ]);
      ...
      if (requests[0].status == "rejected") {
        ...
        let prices = await Promise.all(
          requests.map(
            (request) => request.status == "fulfilled" && request.value.json()
          )
        );
    ...
    async getBalances() {
      ...
      let calls = this.pools.flatMap((k) => {
        return [
          //balanceOf(address)
          [
            allabis[k].token_address,
            "0x70a08231000000000000000000000000" +
              contract.default_account.slice(2),
          ],
          //get_virtual_price
      ...
      helpers
        .chunkArr(decoded, 2)
        .slice(0, this.pools.length)
        .map((v, i) => {
          let key = this.pools[i];
          Vue.set(this.balances, key, (+v[0] * +v[1]) / 1e36);
          if (["tbtc", "ren", "sbtc", "hbtc"].includes(key))
            Vue.set(this.balances, key, this.balances[key] * this.btcPrice);
        });
      let len = decoded.length;
      Vue.set(
        this.balances,
        "susdv2",
        this.balances.susdv2 + (+decoded[len - 3] * decoded[9]) / 1e36
      );
      Vue.set(
        this.balances,
        "sbtc",
        this.balances.sbtc +
          ((+decoded[len - 2] * decoded[15]) / 1e36) * this.btcPrice
      );
      Vue.set(
        this.balances,
        "y",
        this.balances.y + (+decoded[len - 1] * decoded[5]) / 1e36
      );

      for (let pool of Object.values(this.poolInfo)) {
        let callsGauges = calls.slice(callslen);
        let balance = +decodedGaugeBalances[
          callsGauges.findIndex((callGauge) => callGauge[0] == pool.gauge)
        ];
        if (["ren", "sbtc"].includes(pool.name)) balance *= this.btcPrice;
        Vue.set(
          this.balances,
          pool.name,
          this.balances[pool.name] + balance / 1e18
        );
      }
    },
    handle_pool_change(e) {
      if (
        document.querySelector("#from_currency") == document.activeElement ||
        document.querySelector("#custom_slippage_input") ==
          document.activeElement ||
        document.querySelector("#custom_gas_input") == document.activeElement
      )
        return;
    ...
    async getAPY() {
      ...
      for (let [key, value] of Object.entries(volumeStore.state.volumes)) {
        if (
          volumeStore.state.volumes[key] &&
          volumeStore.state.volumes[key][0] == -1
        ) {
          let volume =
            key == "ren"
              ? stats.volume.ren2
    ...
    async getCRVAPY() {
      ...
      let weightCalls = this.decodedGauges.map((gauge) => [
      ...
      let wrapper = new GraphQLClient(
        "https://api.thegraph.com/subgraphs/name/pengiundev/curve-gauges-mainnet"
      );
      ...
      for (let gaugeBoost of results) {
        let pool = Object.values(this.poolInfo).find(
          (pool) => pool.gauge.toLowerCase() == gaugeBoost.gauge.toLowerCase()
        );
        ...
        this.CRVAPYs[pool.name].push(
          this.CRVAPYs[pool.name][0] * this.boosts[pool.name]
        );
      }
...
@media only screen and (min-device-width: 320px) and (max-device-width: 730px) {
  ...
  .poolsdialog.poolsdialog > div span.pooltext,
  .poolsdialog.poolsdialog > div span.index {
    display: inline;
  }
  .pools {
    width: 100%;
