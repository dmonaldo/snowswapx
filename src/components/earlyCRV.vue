  ...
  <div class="window white">
    <fieldset>
      ...
      <div class="info-message gentle-message">
        <a href="https://dao.snowswap.org/minter/vesting">Vesting UI - claim CRV</a>
      </div>
      <div class="input">
      ...
      <div class="datainfo">
        <a href="https://github.com/curvefi/early-user-distribution">
          Calculation script
        </a>
        <a href="https://github.com/curvefi/CRV-distribution-data">
          Data subgraphs
        </a>
        <a href="https://guides.snowswap.org/crv-launches-curve-dao-and-crv/">
          Curve launches Curve DAO and CRV
        </a>
      </div>
      <div class="info-message gentle-message">
...
export default {
  ...
  methods: {
    async mounted() {
      ...
      if (this.address) this.submit();
    },
    async submit() {
      if (!this.address) return;
      let crv = await fetch(
        "https://pushservice.snowswap.org/earlyCRV/" + this.address
      );
      crv = await crv.json();
      crv = crv.CRV;
